...
declare global {
  interface EMRElement extends HTMLElement {
    ...
    /** 加载指定类型的病历模板文档 */
    LoadDocumentFromString: (strData: string, strFormat?: DocumentFormat, specifyLoadPart?: string, errorCallback?: () => void) => boolean;
...
declare global {
  interface Window {
    ...
    /** 内容改变事件 */
    WriterControl_DocumentContentChanged: (rootElement: EMRElement, args: { WriterControl: EMRElement }) => void
  }
}
